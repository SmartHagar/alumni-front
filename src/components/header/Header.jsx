...
const Header = () => {
  ...
  const showMenuMobile = () => {
    ...
    if (showMenu) {
      ...
      menuMobile.classList.add("nav-menu--is-open");
    } else {
      document.body.classList.remove("nav-open-noscroll");
      header.classList.remove("h-full");
      menuMobile.classList.remove("nav-menu--is-open");
    }
    ...
    <header className="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
      <div className="flex items-center px-6 py-6 xl:px-24">
        ...
        <div
          ...
          className={`${
            showMenu ? "hidden" : ""
          } " fixed inset-0 z-10 ml-auto items-center lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent"`}
        >
          {/* <!-- Mobile Logo / Menu Close --> */}
          <div className="t-0 fixed left-0 z-10 flex w-full items-center justify-between p-6 lg:hidden">
            {/* <!-- Mobile Menu Close --> */}
            <button
              onClick={showMenuMobile}
              className="absolute right-6 top-6 hover:bg-accent focus:bg-accent group dark:hover:bg-accent ml-2 flex h-10 w-10 items-center justify-center rounded-full border bg-white transition-colors hover:border-transparent focus:border-transparent dark:border-transparent dark:bg-white/[.15]"
          ...
          >
            <input
              type="search"
              className="text-jacarta-700 placeholder-jacarta-500 focus:ring-accent w-full rounded-2xl border py-3 px-4 pl-10 dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white"
              placeholder="Search"
            />
          ...
          <div className="ml-8 hidden lg:flex xl:ml-12">
            ...
            <div className="js-nav-dropdown group-dropdown relative">
              ...
              >
                <svg
                  ...
                  width="24"
                  height="24"
                  className="h-4 w-4 transition-colors group-hover:fill-pink-700 group-focus:fill-pink-700 dark:fill-white"
                >
                  <path fill="none" d="M0 0h24v24H0z" />
            ...
            >
              <svg
                ...
                width="24"
                height="24"
                className=" dark-mode-light h-4 w-4 transition-colors group-hover:fill-pink-700 group-focus:fill-pink-700 dark:hidden"
              >
                <path fill="none" d="M0 0h24v24H0z" />
              ...
              <svg
                ...
                width="24"
                height="24"
                className=" dark-mode-dark hidden h-4 w-4 transition-colors group-hover:fill-pink-700 group-focus:fill-pink-700 dark:block dark:fill-white"
              >
                <path fill="none" d="M0 0h24v24H0z" />
        ...
        {/* <!-- Mobile Menu Actions --> */}
        <MenuMoblie gantiTema={gantiTema} showMenuMobile={showMenuMobile} />
      </div>
    </header>
  );
};
