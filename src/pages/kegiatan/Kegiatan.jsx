  ...
  return (
    <div>
      ...
      <BgPage>
        ...
        {/* card */}
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 place-content-center place-items-center md:place-items-end">
          {arrData &&
            arrData.map((row, index) => (
              <div
                key={index}
                className="max-w-sm mb-4 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
              >
                <Link to="#">
                  <img
